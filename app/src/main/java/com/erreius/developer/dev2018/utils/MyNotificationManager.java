    ...
    public void showSmallNotification(String title, String id, String titulo, String descripcion, String link) {
        ...
        //if (!prefs.getString("suscriptor", "").equals("") && !prefs.getString("clave", "").equals("")) {
            if (id.equals("0")) {
                ...
                Intent resultIntent = new Intent(mCtx, MasterView.class);
                resultIntent.putExtra("url", link);
                resultIntent.putExtra("type", "Push");
                ...
                stackBuilder.addParentStack(MasterView.class);
                ...
                notification = mBuilder.setSmallIcon(R.drawable.ic_bell).setTicker(title).setWhen(0)
                        .setAutoCancel(true)
                        .setContentIntent(resultPendingIntent)
                        .setFullScreenIntent(resultPendingIntent,true)
                        .setContentTitle(title)
                        .setSmallIcon(R.drawable.ic_bell)
                        .setLargeIcon(BitmapFactory.decodeResource(mCtx.getResources(), R.drawable.ic_bell))
